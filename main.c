...
int main()
{
    ...
    vertex_buffer* vb = vbuffer_create(vertices,sizeof(float)*12);
    index_buffer* ib = ibuffer_create(indices,6);
    vertex_array* va = varray_create();
    vertex_buffer_layout* vbl = vbl_create(1);
    vbl_push_f(vbl, 3);

    varray_addbuffer(va, vb, vbl);
